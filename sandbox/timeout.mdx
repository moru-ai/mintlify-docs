...
The default timeout is **1 hour** (3600 seconds). After this period of inactivity, the sandbox is automatically killed.
...
// Custom timeout (30 minutes)
const sandbox = await Sandbox.create({ timeoutMs: 1800000 })
```
</CodeGroup>
